...
export class RowMenu extends BaseMenu {
  ...
  async showRenameSchema(sheet, schema, returnCallback) {
    ...
    try {
      ...
      // Create updated schema object with the new name
      const updatedSchema = { ...schema, name: newName.trim() }
  ...
  async showEditQuery(sheet, schema, query, returnCallback) {
    ...
    try {
      ...
      await sheet.updateQuery(query.queryId, newQueryName.trim(), newQueryText.trim(), Boolean(query.listView))
